...
public class AHRS2 : MonoBehaviour {

    /// <summary>
    /// Gets or sets the sample period.
    /// </summary>
    public static float SamplePeriod = 1f / 60f;

    /// <summary>
    /// Gets or sets the algorithm gain beta.
    /// </summary>
    public static float Beta = .6f;

    /// <summary>
    /// Gets or sets the Quaternion output.
    /// </summary>
    public static Quaternion quat = Quaternion.identity;
    ...
    /// Total sqrt: 5
    /// </remarks> 
    public static void Update(Quaternion attitude, float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz)
    { // q1 = w, q2 = x, q3 = y, q4 = z
        ...
        //// Try with attitude in stead of velocity
        //qDot1 = 0.5f * attitude.w - Beta * s1;
        //qDot2 = 0.5f * attitude.x - Beta * s2;
        //qDot3 = 0.5f * attitude.y - Beta * s3;
        //qDot4 = 0.5f * attitude.z - Beta * s4;
    ...
    /// Total sqrt: 3
    /// </remarks>
    public static void Update(float gx, float gy, float gz, float ax, float ay, float az)
    {
        float q1 = quat.w, q2 = quat.x, q3 = quat.y, q4 = quat.z;   // short name local variable for readability
        float norm;
        float s1, s2, s3, s4;

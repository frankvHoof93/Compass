...
/// <summary>
/// Gyro that only rotates over 1 axis
/// Allows player to look left & right only
/// </summary>
[RequireComponent(typeof(Camera))]
public class SingleAxisGyro : MonoBehaviour {
    #region Variables
    #region Public
    /// <summary>
    ...
    void Update()
    {
        ...
        {
            if (useFilter)
                cameraContainer.transform.Rotate(0f, initialOrientation.y - Input.gyro.rotationRateUnbiased.y, 0f);
            else
